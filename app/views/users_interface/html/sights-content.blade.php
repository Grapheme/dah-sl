<section class="sights-page">
	...
	<section class="map">
		<img class="main-map" src="img/map/map.png" alt="">
		<a href="#" target="_blank" class="map-link mechet">
		...
		<a href="#" target="_blank" class="map-link monastery">
			<div class="cond-container">
		...
		<a href="#" target="_blank" class="map-link kazstone">
			<div class="cond-container">
		...
		<a href="#" target="_blank" class="map-link trezmount">
			<div class="cond-container">
		...
		<a href="<?=URL::to('sights/azishskaya-peshera');?>" target="_blank" class="map-link azishcave">
			<div class="cond-container">
				<img class="main-img" src="img/map/sites/b_cave.png" alt="">
				<img class="shadow" src="img/map/sites/shadows/b_cave.png" alt="">
			</div>
		...
		<a href="#" target="_blank" class="map-link partpole">
			<div class="cond-container">
		...
		<a href="#" target="_blank" class="map-link dolmen">
			<div class="cond-container">
		...
		<a href="#" target="_blank" class="map-link lagonaki">
			<div class="cond-container">
				<img class="main-img" src="img/map/sites/mountain.png" alt="">
				<img class="shadow" src="img/map/sites/shadows/mountain.png" alt="">
			</div>
		...
		<a href="<?=URL::to('sights/guamskoe-ushelie');?>" target="_blank" class="map-link guamcave">
			<div class="cond-container">
				<img class="main-img" src="img/map/sites/flag.png" alt="">
				<img class="shadow" src="img/map/sites/shadows/flag.png" alt="">
			</div>
